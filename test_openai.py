...
os.environ['PYAWK_AI_PROVIDER'] = 'openai'
...
from ai_providers import get_ai_provider, reset_provider, OpenAIProvider
...
try:
    ...
    print(f"OpenAI API Key available: {bool(provider.api_key)}")
